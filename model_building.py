# -*- coding: utf-8 -*-
"""
Created on Sat Sep  5 22:42:37 2020
...
df = pd.read_csv('C:/Users/Reid/Documents/ds_salaries/data_eda.csv')
...
df_model = df[['avg_salary','Rating','Size','Type of ownership','Industry','Sector',
             ...
             'age','python_yn','spark_yn','aws_yn','excel_yn','job_simp','seniority','desc_len']]
